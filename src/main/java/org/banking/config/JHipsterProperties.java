...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "banking@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "banking API";

        private String description = "banking API documentation";
